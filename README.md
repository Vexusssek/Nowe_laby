...
from __future__ import annotations
        ...
        print(f"Ĺadowanie modelu: {LOCAL_MODEL_NAME}")
        ...
        prompt = "StwĂłrz 3 punktowÄ listÄ porad jak uczyÄ siÄ efektywnie."
        ...
        logits = [-2.0, 1.0, 0.0, 0.5, -1.0]  # przykĹadowe logity
        idx, simple_probs, raw_probs, filtered_probs, mask = sample_next_token(
            logits,
            temperature=1,
            top_p=0.5,   # lub 1.0, jeĹli bez nukleusa
